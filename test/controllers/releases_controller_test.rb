...
class ReleasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post releases_url, params: { release: { account_id: @release.account_id, release_type: @release.release_type, value: @release.value } }
    end
  ...
  test "should update release" do
    patch release_url(@release), params: { release: { account_id: @release.account_id, release_type: @release.release_type, value: @release.value } }
